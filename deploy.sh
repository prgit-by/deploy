...
SITE_URL="https://codeload.github.com/prgit-by/site/tar.gz/$SITE_BRANCH"

DEPLOY_BRANCH='master'
DEPLOY_URL="https://codeload.github.com/prgit-by/deploy/tar.gz/$DEPLOY_BRANCH"

FEE_DIR="$PRGIT_DIR/fee"
FEE_BRANCH='master'
FEE_URL="https://codeload.github.com/prgit-by/fee/tar.gz/$FEE_BRANCH"
